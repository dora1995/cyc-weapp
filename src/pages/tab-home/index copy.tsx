...
const newTabs = [
  { name: "定位查", icon: Icon1, component: null },
  { name: "对口查", icon: Icon2, component: null },
  { name: "定位查", icon: Icon3, component: null },
  { name: "定位查", icon: Icon4, component: null },
  { name: "定位查", icon: Icon5, component: null },
];
